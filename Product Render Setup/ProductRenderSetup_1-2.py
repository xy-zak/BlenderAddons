...
def create_rim_light(context, focus_object, strength=5.0, temperature=5500.0):
    ...
    light_distance = focus_object.dimensions.length * 1.5
    ...
    # Make the light point at the object
    light_to_obj = (obj_location - light_location).normalized()
    rot_quat = light_to_obj.to_track_quat('Z', 'Y')
